...
switch ($requestMethod) {
    case 'GET':
        ...
        // Call the getPendingLossOfPointers method of the Users class and pass parameters to it
        $api->getPendingLossOfPointers($page, $limit, $search, $sortBy, $sortOrder, $fromDate, $toDate);
        break;
    default:
