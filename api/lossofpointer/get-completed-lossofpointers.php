...
switch ($requestMethod) {
    case 'GET':
        ...
        // Call the getCompletedLossOfPointers method of the Users class and pass parameters to it
        $api->getCompletedLossOfPointers($page, $limit, $search, $sortBy, $sortOrder, $fromDate, $toDate);
        break;
    default:
